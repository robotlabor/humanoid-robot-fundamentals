...
The workshop uses a simplified humanoid model first. A Unitree G1 model can be imported at the end as a more realistic example.
...
## 6. Test the model without graphics
...
## 21. Student task: inspect the model dimensions
...
## 22. Student task: inspect joint names
...
## 23. Student task: modify a material
...
## 24. Student task: modify one joint limit
...
## 31. Student task: compare linear and smooth motion
...
## 32. Student task: modify actuator gain
...
## 33. Student task: modify joint damping
...
## 41. Student task: compare left and right foot force
...
## 43. Student task: friction experiment
...
## 44. Student task: modify the lateral disturbance
...
## 52. Fall criterion based on pelvis height
...
## 53. Fall criterion based on torso orientation
...
## 55. Student task: change the fall threshold
...
## 56. Student task: compare equal impulses
...
## 57. Student task: compare friction during the push
...
## 58. Final engineering challenge
...
## 8. Friction change has little visible effect
...
## 9. Touch sensor always reads zero
